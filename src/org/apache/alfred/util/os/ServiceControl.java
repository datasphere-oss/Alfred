...
public abstract class ServiceControl {
    ...
    public abstract void create(String id, String description, String binPath, CreationParameters params)
    ...
    public abstract void startAndWait(String id, boolean ignoreQueryErrors, long timeout)
            throws IOException, InterruptedException;

    public abstract void stop(String id) throws IOException, InterruptedException;

    public abstract void stopAndWait(String id, boolean ignoreQueryErrors, long timeout)
            throws IOException, InterruptedException;

    public abstract void setFailureAction(String id, FailureAction action, int delay, String command)
            throws IOException, InterruptedException;
}
