...
public class WindowsServiceControl extends ServiceControl {
    ...
    public void create(String id, String description, String binPath, CreationParameters params)
        ...
        // see http://support.microsoft.com/default.aspx?scid=kb;en-us;812486
        try {
            REGISTRY.writeStringValue(HKey.HKLM, "SYSTEM\\CurrentControlSet\\Services\\" + id, "ImagePath", binPath);
        } catch (Throwable x) {
    ...
    public String getExecutablePath(String id) throws InvocationTargetException, IllegalAccessException {
        ...
        return WindowsUtils.regQuery(HKey.HKLM, "SYSTEM\\CurrentControlSet\\Services\\" + id, "ImagePath");
    }
    ...
    public void stopAndWait(String id, boolean ignoreQueryErrors, long timeout)
        ...
        for (;;) {
            ...
            // FIXME: PaharelauK error 1060 - The specified service does not exist as an
            // installed service.
    ...
    private static void query(String id, Status out) throws IOException, InterruptedException {
        ProcessBuilder pb = pb("query", id);
        String output = exec(pb);
    ...
    private static String queryExitCode(String id) throws IOException, InterruptedException {
        ProcessBuilder pb = pb("query", id);
        String output = exec(pb);
    ...
    private static void setDescription(String id, String description) throws IOException, InterruptedException {
    ...
    private static void throwException(ProcessBuilder pb, String output) throws IOException {
        StringBuilder sb = new StringBuilder();
    ...
    private static void throwException(ProcessBuilder pb, int code) throws IOException {
        StringBuilder sb = new StringBuilder();
    ...
    private static String exec(ProcessBuilder pb) throws IOException, InterruptedException {
        return exec(pb, false);
    }

    private static String exec(ProcessBuilder pb, boolean ignoreExitCode) throws IOException, InterruptedException {
    ...
    private static void runSimple(String cmd, String id, String expect) throws IOException, InterruptedException {
