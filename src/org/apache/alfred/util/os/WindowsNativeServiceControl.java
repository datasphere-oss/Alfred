...
public class WindowsNativeServiceControl extends ServiceControl {
    ...
    @Override
    public native void start(String id) throws IOException, InterruptedException;

    @Override
    public native void stop(String id) throws IOException, InterruptedException;

    @Override
    public native void delete(String id) throws IOException, InterruptedException;

    @Override
    public native void addDependency(String id, String dependId) throws IOException, InterruptedException;

    @Override
    public native void create(String id, String description, String binPath, CreationParameters params)
            throws IOException, InterruptedException;

    @Override
    public native String queryStatusName(String id) throws IOException, InterruptedException;
    ...
    @Override
    public native String getExecutablePath(String id) throws InvocationTargetException, IllegalAccessException;

    @Override
    public native boolean exists(String id) throws IOException, InterruptedException;

    public static native String queryExitCode(String id) throws IOException, InterruptedException;

    public static native String queryServiceExitCode(String id) throws IOException, InterruptedException;
