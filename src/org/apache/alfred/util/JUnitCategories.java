...
package org.apache.alfred.util;

/**
 * This class is test-related and should not be actually placed in "main" code.
 * However we need to access this class from all test modules and the simplest
 * way to achieve this is to put it into a common module (like this one).
 * Alternative is to have a dedicated module for test utility classes. TODO:
 * Move this class to a test utility module if such module appears.
 */
