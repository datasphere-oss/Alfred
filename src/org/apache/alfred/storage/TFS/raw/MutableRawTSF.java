...
import org.apache.alfred.storage.codecs.BlockCompressor;
import org.apache.alfred.storage.codecs.BlockCompressorFactory;
import org.apache.alfred.storage.codecs.TSFFormat;
import org.apache.alfred.storage.codecs.TSNames;
import org.apache.alfred.storage.impl.FileUtils;
...
public class MutableRawTSF extends RawTSF {
    ...
    public void saveTo() throws IOException {
        ...
        if (compressed) {
            ...
            compressor = BlockCompressorFactory.createCompressor(compression + "(" + compressionLevel + ")",
                    compressedData);
            ...
            for (int ii = 0; ii < numEntities; ii++) {
                ...
                if (db.getDataLength() == 0)
                    ...
                    compLengths[ii] = compressor.deflate(db.getData(), 0, db.getDataLength(), compressedData);
            }
    ...
    private int computeIndexBlockSize(boolean compressed, int numEntities) {
