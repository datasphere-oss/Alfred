...
public abstract class RawNode {
    ...
    public final void readIndex(DiagListener dlnr) throws IOException {
        readIndex(Verifier.TS_UNKNOWN, Verifier.TS_UNKNOWN, dlnr);
    }

    public abstract void readIndex(long startTimestamp, long limitTimestamp, DiagListener dlnr) throws IOException;
