...
abstract class BlockAccessorBase extends DataAccessorBase {
     ...
     */
    private final IntegerToObjectHashMap<AccessorBlockLink> links = new IntegerToObjectHashMap<>();
    ...
    @Override
    public void asyncDataDropped(DataBlock db, int dataOffset, int length, long nextTime) {
