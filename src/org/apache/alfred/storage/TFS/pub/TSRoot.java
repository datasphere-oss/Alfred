...
import org.apache.alfred.storage.pub.AbstractFileSystem;
import org.apache.alfred.storage.pub.AbstractPath;
...
public interface TSRoot {
    ...
    /**
     * @return name of space, may be {@code null} if space name was not explicitly
     *         assigned
     */
    @Nullable
    String getSpace();
     ...
     *
     * <pre>
     *  signum(String.compare(r1.getSpace(), r2.getSpace()) == signum(Integer.compare(r1.getSpaceIndex(), r2.getSpaceIndex())
     * </pre>
     * 
     * This means that sorting by value of getSpaceIndex() produces same order as
     * sorting by {@link TSRoot#getSpace()}
     */
    int getSpaceIndex();
}
