...
/**
 * Hand-optimized priority queue of AccessorBlockLink objects. Analogous to
 * java.util.PriorityQueue &lt;AccessorBlockLink&gt;
 */
final class ABLPQ {
    /**
        ...
        for (int pos = 1; pos <= size; pos++) {
            ...
            if (leftChildPos <= size) {
                ...
                if (child.getNextTimestamp() < obj.getNextTimestamp())
                    throw new RuntimeException("(L) child at " + leftChildPos + ": " + child + " < parent: " + obj
                            + "; parent pos: " + pos);
            }
            ...
            if (rightChildPos <= size) {
                ...
                if (child.getNextTimestamp() < obj.getNextTimestamp())
                    throw new RuntimeException("(R) child at " + rightChildPos + ": " + child + " < parent: " + obj
                            + "; parent pos: " + pos);
            }
        }
    }
