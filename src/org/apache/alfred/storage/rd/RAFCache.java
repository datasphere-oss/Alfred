...
public class RAFCache {
    ...
    public class RAF extends RandomAccessFile {
        ...
        public void close() throws IOException {
            ...
            if (RAMDisk.ASSERTIONS_ENABLED) {
                assert fd.uniqueRAFcheck == this : "Unexpected: " + fd.uniqueRAFcheck + " != " + this;
    ...
    synchronized void beingClosed(FD fd) {
        ...
        if (cookie != null) {
            try {
                ...
                throw new org.apache.alfred.util.io.UncheckedIOException(
                        "Unexpected error closing RandomAccessFile " + fd.getFile(), iox);
            }
    ...
    synchronized RAF checkOut(FD fd) throws IOException {
        for (;;) {
            //
            // Return cached file
            //
            ...
            if (cookie != null) {
                assert cookie.checkOutRefCount == 0 : "Checked out cookie found in the LRU list";
            ...
            // RAMDisk.LOGGER.info ("RAFCache is out of files (" + numOpenFiles + " open);
            // will wait.");
