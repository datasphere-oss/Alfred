...
final class SavePageJob {
    ...
    /**
     * Whether at the time of assigning the job all pages prior to the current one
     * were clean. This flag triggers the clean commit event handler.
     */
     ...
     * followsCleanRange, as pages prior to the current one may have become dirty.
     * This flag triggers the auto-commit logic (if enabled).
     */
