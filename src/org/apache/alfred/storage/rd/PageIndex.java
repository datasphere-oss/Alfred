...
final class PageIndex extends QuickList.Entry<PageIndex> implements Comparable<PageIndex> {
    ...
    boolean getNextJob(SavePageJob job) {
        ...
        assert nextPageIndexToSave >= firstDirtyPageIndex : "nextPageIndexToSave == " + nextPageIndexToSave
    ...
    void jobCompleted(Page page) {
        ...
        assert get(idx) == page : "jobCompleted called with " + page + " but pages [" + idx + "] == " + get(idx);
        ...
        if (idx != firstDirtyPageIndex) {
            ...
            //
            assert firstDirtyPageIndex < idx : "firstDirtyPageIndex jumped up from " + idx + " to "
                    + firstDirtyPageIndex;
    ...
    /**
     * Returns whether this index has pages in the DIRTY or UNSAVED state. This is
     * determined by examining the dirty range.
     */
    ...
    void setPageDirty(Page page) {
        ...
        assert get(idx) == page : "setPageDirty called with " + page + " but pages [" + idx + "] == " + get(idx);
    ...
    boolean truncate(long length) {
        ...
        long newNumPages = length > fd.getPrivateHeaderLength()
                ? DataCache.getPageIndex(fd, DataCache.PAGE_SIZE + length - 1)
                : 1;
    ...
    public String toString() {
        return ("PageIndex (fd: " + fd + "; dirty range: " + firstDirtyPageIndex + " .. " + lastDirtyPageIndex + ")");
    }
