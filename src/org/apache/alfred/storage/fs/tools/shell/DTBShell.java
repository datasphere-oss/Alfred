...
package org.apache.alfred.storage.tools.shell;

import org.apache.alfred.storage.fs.local.*;
import org.apache.alfred.storage.fs.pub.*;
import org.apache.alfred.storage.fs.raw.*;
import org.apache.alfred.storage.util.cmd.AbstractShellEx;
import org.apache.alfred.util.cmdline.*;
import org.apache.alfred.util.time.*;
import java.io.*;
...
public class DTBShell extends AbstractShellEx {
    private final DiagPrinter diagPrinter = new DiagPrinter();
    ...
    public static String formatTime(long t) {
        ...
        return (GMT.formatDateTime(t / 1000000) + "." + String.format("%09d", t % 1000000000L));
    }
    ...
    public void cmd_ls(String arg) throws IOException {
        ...
        if (f == null)
            ...
            for (int ii = 0; ii < n; ii++) {
                ...
                if (child.isFile())
                    System.out.printf("#%,5d: %s      %s      %,7d KB\n", ii, child.getName(), tstext,
