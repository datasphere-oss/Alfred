...
public interface HeapManager extends Loggable {
     ...
     *
     * <p>
     * WARN: Caller is responsible for releasing allocated buffer at some later
     * point to prevent memory leaks!
     * </p>
     * <p>
     * WARN: Caller must not change byte buffer size!
     * </p>
     *
     * @param block output buffer
     * @return false if heap is out of memory (of given size), in which case block
     *         size is set to zero
     */
     ...
     * </p>
     * <p>
     * WARN: Caller must NOT de-allocate block twice.
     * </p>
     * 
     * @param block
     */
    ...
    /**
     * @return maximum size of allocation unit and also total amount of memory in
     *         heap
     */
    long getHeapSize();
