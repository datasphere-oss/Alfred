...
public final class ChunkCachingFileSystem implements AbstractFileSystem, Wrapper<AbstractFileSystem> {
     ...
     * @param expectedMaxFileSizeInBytes expected maximum file size (bytes).
     *                                   Controls default number of chunks in
     *                                   {@link ChunkCacheFsEntry}.
     * @param preallocateRatio           value in range [0..1] defining the portion
     *                                   of cache to be immediately allocated
     */
    public ChunkCachingFileSystem(AbstractFileSystem delegate, long cacheSizeInBytes, int expectedMaxFileSizeInBytes,
    ...
    public long getReopenOnSeekThreshold() {
        // This cache handles reopen/seek internally so there is no need to do that
        // manually.
        return 0;
    }
