...
package org.apache.alfred.storage.fs.common;
...
/**
 * @param <T> Type of wrapping class. We need it to enforce correct wrapping
 *            everywhere.
 */
public abstract class DelegatingAbstractPath<T extends AbstractPath> implements AbstractPath, Wrapper<AbstractPath> {
    ...
    public AbstractFileSystem getFileSystem() {
        throw new IllegalStateException(
                "This method must be overridden in child class an should return wrapping file system");
    }
