...
package org.apache.alfred.network;

import java.nio.channels.SelectionKey;
import org.apache.alfred.network.codec.Debug;
import org.apache.alfred.network.codec.Output;
...
public enum FlowControl implements Debug {
  ...
  /**
   * <em>accept</em>, <em>connect</em>, <em>read</em>, and <em>write</em>
   * disabled.
   */
  WAIT(0x0),

  /**
   * <em>accept</em> enabled; <em>connect</em>, <em>read</em>, and <em>write</em>
   * disabled.
   */
  ACCEPT(0x1),

  /**
   * <em>connect</em> enabled; <em>accept</em>, <em>read</em>, and <em>write</em>
   * disabled.
   */
  CONNECT(0x2),

  /**
   * <em>accept</em> and <em>connect</em> enabled; <em>read</em> and
   * <em>write</em> disabled.
   */
  ACCEPT_CONNECT(0x3),

  /**
   * <em>read</em> enabled; <em>accept</em>, <em>connect</em>, and <em>write</em>
   * disabled.
   */
  READ(0x4),

  /**
   * <em>accept</em> and <em>read</em> enabled; <em>connect</em> and
   * <em>write</em> disabled.
   */
  ACCEPT_READ(0x5),

  /**
   * <em>connect</em> and <em>read</em> enabled; <em>accept</em> and
   * <em>write</em> disabled.
   */
  CONNECT_READ(0x6),

  /**
   * <em>accept</em>, <em>connect</em>, and <em>read</em> enabled; <em>write</em>
   * disabled.
   */
  ACCEPT_CONNECT_READ(0x7),

  /**
   * <em>write</em> enabled; <em>accept</em>, <em>connect</em>, and <em>read</em>
   * disabled.
   */
  WRITE(0x8),

  /**
   * <em>accept</em> and <em>write</em> enabled; <em>connect</em> and
   * <em>read</em> disabled.
   */
  ACCEPT_WRITE(0x9),

  /**
   * <em>connect</em> and <em>write</em> enabled; <em>accept</em> and
   * <em>read</em> disabled.
   */
  CONNECT_WRITE(0xa),

  /**
   * <em>accept</em>, <em>connect</em>, and <em>write</em> enabled; <em>read</em>
   * disabled.
   */
  ACCEPT_CONNECT_WRITE(0xb),

  /**
   * <em>read</em> and <em>write</em> enabled; <em>accept</em> and
   * <em>connect</em> disabled.
   */
  READ_WRITE(0xc),

  /**
   * <em>accept</em>, <em>read</em>, and <em>write</em> enabled; <em>connect</em>
   * disabled.
   */
  ACCEPT_READ_WRITE(0xd),

  /**
   * <em>connect</em>, <em>read</em>, and <em>write</em> enabled; <em>accept</em>
   * disabled.
   */
  ...
  /**
   * Returns an updated {@code FlowControl} with its <em>accept</em> operation
   * disabled.
   */
  ...
  /**
   * Returns an updated {@code FlowControl} with its <em>connect</em> operation
   * disabled.
   */
  ...
  /**
   * Returns an updated {@code FlowControl} with its <em>read</em> operation
   * disabled.
   */
  ...
  /**
   * Returns an updated {@code FlowControl} with its <em>write</em> operation
   * disabled.
   */
  ...
  private static FlowControl fromFlags(int flags) {
    switch (flags) {
      ...
      case 0x2:
        return FlowControl.CONNECT;
      case 0x3:
        return FlowControl.ACCEPT_CONNECT;
      case 0x4:
        return FlowControl.READ;
      case 0x5:
        return FlowControl.ACCEPT_READ;
      case 0x6:
        return FlowControl.CONNECT_READ;
      case 0x7:
        return FlowControl.ACCEPT_CONNECT_READ;
      case 0x8:
        return FlowControl.WRITE;
      case 0x9:
        return FlowControl.ACCEPT_WRITE;
      case 0xa:
        return FlowControl.CONNECT_WRITE;
      case 0xb:
        return FlowControl.ACCEPT_CONNECT_WRITE;
      case 0xc:
        return FlowControl.READ_WRITE;
      case 0xd:
        return FlowControl.ACCEPT_READ_WRITE;
      case 0xe:
        return FlowControl.CONNECT_READ_WRITE;
      case 0xf:
        return FlowControl.ACCEPT_CONNECT_READ_WRITE;
      default:
  ...
  /**
   * Returns the {@code FlowControl} corresponding to the given
   * {@link SelectionKey} interest set.
   */
