...
public enum FlowModifier implements Debug {
  ...
  /**
   * <em>read</em> operation should be disabled; <em>write</em> operation should
   * not be modified.
   */
  DISABLE_READ(0x1),

  /**
   * <em>write</em> operation should be disabled; <em>read</em> operation should
   * not be modified.
   */
  DISABLE_WRITE(0x2),
  ...
  /**
   * <em>read</em> operation should be enabled; <em>write</em> operation should
   * not be modified.
   */
  ENABLE_READ(0x4),
  ...
  /**
   * <em>write</em> operation should be enabled; <em>read</em> operation should
   * not be modified.
   */
  ENABLE_WRITE(0x8),
  ...
  /**
   * Returns the {@code FlowModifier} with all modifications applied in {@code
   * this} or {@code that}—but not both—applied, with enable instructions taking
   * precedence over conflicting disable instructions.
   */
   ...
   * this} unapplied, and all unapplied operations in {@code this} applied, with
   * enable instructions taking precedence over conflicting disable instructions.
   */
  ...
  private static FlowModifier fromFlags(int flags) {
    ...
    switch (flags) {
      case 0x0:
        return FlowModifier.RESELECT;
      case 0x1:
        return FlowModifier.DISABLE_READ;
      case 0x2:
        return FlowModifier.DISABLE_WRITE;
      case 0x3:
        return FlowModifier.DISABLE_READ_WRITE;
      case 0x4:
        return FlowModifier.ENABLE_READ;
      case 0x6:
        return FlowModifier.DISABLE_WRITE_ENABLE_READ;
      case 0x8:
        return FlowModifier.ENABLE_WRITE;
      case 0x9:
        return FlowModifier.DISABLE_READ_ENABLE_WRITE;
      case 0xc:
        return FlowModifier.ENABLE_READ_WRITE;
      default:
