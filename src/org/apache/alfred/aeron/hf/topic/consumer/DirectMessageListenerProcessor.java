...
import org.apache.alfred.aeron.hf.pub.*;
...
class DirectMessageListenerProcessor implements SubscriptionWorker {
    ...
    DirectMessageListenerProcessor(MessageProcessor processor, Aeron aeron, boolean raw, String channel,
            int dataStreamId, CodecFactory codecFactory, TypeLoader typeLoader, List<RecordClassDescriptor> types,
        ...
        this.fragmentHandler = new MessageFragmentHandler(raw, codecFactory, typeLoader, types, mappingSnapshot,
                mappingProvider);
