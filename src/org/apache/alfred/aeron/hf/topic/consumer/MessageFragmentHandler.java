...
class MessageFragmentHandler implements ControlledFragmentHandler {
    ...
    MessageFragmentHandler(boolean raw, CodecFactory codecFactory, TypeLoader typeLoader,
            List<RecordClassDescriptor> types, ConstantIdentityKey[] mapping, MappingProvider mappingProvider) {
        this.decoder = new DirectMessageDecoder(arrayBuffer, raw, codecFactory, typeLoader, types, mapping,
                mappingProvider);
    }
    ...
    /**
     * Checks if there is a pending unhandled exception. This method should be
     * executed after each poll by this fragment handler.
     */
    void checkException() {
