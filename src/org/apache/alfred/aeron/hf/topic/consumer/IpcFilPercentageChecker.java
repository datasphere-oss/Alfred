...
/**
 * Tracks Aeron subscription {@link Image}s to provide information on fill
 * percentage of incoming message buffer.
 *
 * Implementation detail: {@link #onAvailableImage(Image)} and
 * {@link #onUnavailableImage(Image)} are always called by client conductor
 * thread.
 *
...
class IpcFilPercentageChecker implements AvailableImageHandler, UnavailableImageHandler {
     ...
     *
     * If there are multiple buffers (as in case of multiple publications) then
     * returns maximum value of all.
     *
    ...
    byte getBufferFillPercentage() {
        ...
        for (ImageData data : imageData) {
            ...
            // TODO: Division can be replaced by binary shift because divisor is always a
            // power of two
    ...
    /**
     * Releases acquired resources. It's not permitted to use this object after the
     * method call.
     */
